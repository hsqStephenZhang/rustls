...
#[dynamic]
pub static EDGE_CIPHER: Vec<GreaseOrCipher> = {
    use CipherSuite::*;
    vec![
        GreaseOrCipher::Grease,
        TLS13_AES_128_GCM_SHA256.into(),
...
/// The signature algorithms of edge 106
pub static EDGE_106_SIGNATURE_ALGO: &[SignatureScheme] = &[
    SignatureScheme::ECDSA_NISTP256_SHA256,
    SignatureScheme::RSA_PSS_SHA256,
    SignatureScheme::RSA_PKCS1_SHA256,
    SignatureScheme::ECDSA_NISTP384_SHA384,
...
#[dynamic]
/// The extension list of edge 106
pub static EDGE_106_EXT: Vec<ExtensionSpec> = {
    use ExtensionSpec::*;
    use KeepExtension::*;
    vec![
        Craft(CraftExtension::Grease1),
        ...
        Rustls(ClientExtension::CertificateStatusRequest(OCSP_REQ.clone())),
        Rustls(ClientExtension::SignatureAlgorithms(
            EDGE_106_SIGNATURE_ALGO.to_vec(),
        )),
        Craft(CraftExtension::SignedCertificateTimestamp),
        Craft(CraftExtension::KeyShare(&[
            Grease,
